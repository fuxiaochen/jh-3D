    ...
    <div class="departmentRescue">
        ...
        <template>
            ...
            >
                ...
                <p><b>10.5急救组架设急救站</b></p>
                <div class="support-group">
                    <a-form-model-item prop="rescueTime">
                        <div class="item">
                            <p><span><span class="star">*</span>急救站架设完成时间：</span></p>
                            <a-date-picker :valueFormat="valueFormat" style="width:200px" show-time v-model="rescueData.rescueTime" @change="rescueTimeChange" :disabled="isDisabled" />
                        </div>
                    </a-form-model-item>
              ...
              <div class="content" style="padding-left: 40px">
	            ...
	            <div class="rescue-method" v-if="rescueData.isSeepageSuccess == 1">
                   <div class="item" style="margin-bottom:10px">
		            ...
		            <p> *止漏成功回报监控中心</p>
                    <div class="item" style="margin-bottom:10px" v-if="!showUser">
                        <span><span class="star">*</span>用吸液棉进行围堵/用吸酸车处理，处理完时间:</span>
                        <a-date-picker :valueFormat="valueFormat" style="width:200px" show-time v-model="rescueData.seepageFinishTime" :disabled="isDisabled"/>
                    </div>
                    <div class="item" style="margin-bottom:10px" v-if="showUser">
                        <span><span class="star">*</span>通知厂务加大排风换气，通知时间：</span>
                        <a-date-picker :valueFormat="valueFormat" style="width:200px" show-time v-model="rescueData.aerationFinishTime" :disabled="isDisabled"/>
                    </div>
    ...
    export default {
        ...
        methods:{
            ...
            viewData() {
                ...
                this.$http.get3('/chemAreaErtRescue/queryOne?processInstanceId=' + this.processInstanceId).then(res => {
                    if (res.data.data){
                    ...
                    this.rescueData = {
                        ...
                        cleanTime:tempData.supportTime,
                        ...
                        seepageFinishTime:tempData.seepageFinishTime,
                        aerationFinishTime:tempData.aerationFinishTime,
                ...
                this.$refs[formName].validate(valid => {
                    if (valid) {
                        let data = {
                            ...
                            supportTime:this.rescueData.cleanTime,
                            ...
                            seepageFinishTime:this.rescueData.seepageFinishTime,
                            aerationFinishTime:this.rescueData.aerationFinishTime,
                        ...
                        this.$http.post3('/chemAreaErtRescue/executeProcess', data).then(res => {
                            if (res.data.code === 1) {
                                let data = {
                                    processInstanceId:this.processInstanceId
                                }
            ...
            saveData(){
                ...
                this.$http.post3('/chemAreaErtRescue/saveOrUpdate', data).then(res => {
                })
            },
            //添加现场环境持续检测
            ...
            //发送部门ERT灭火成功简讯
            newsfireFailureTimeChange(e,val){
                this.rescueData.fireFailureTime = val
            },
            //启动事故排烟
