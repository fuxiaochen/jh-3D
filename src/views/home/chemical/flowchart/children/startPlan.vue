    ...
    <div class="startPlan">
        ...
        <template>
            <a-form-model
                    ...
                    :rules="rules"
            >
                <h3><span class="star">*</span>化灾报警</h3>
                    <a-row :gutter="2">
                        <a-col class="gutter-row" :span="10">
                            <div class="gutter-box">
                                <div class="noticeBaseData-item">
                                    <div class="value">
                                        <a-form-model-item prop="spe">
                                            <a-radio-group v-model="noticeData.spe" :disabled="isDisabled||seeDisabled">
                                                <a-radio :value="1">
                                                    人员通报 
                                                </a-radio>
                                                <a-radio :value="2">
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    spe: [{required: true, message: '请选择化灾报警', trigger: 'blur'}],
                },
                departmentList: [
                    {
                        id: 1,
        ...
        methods: {
                ...
                this.$refs[formName].validate(valid => {
                    if (valid) {
                        ...
                        let data ={
                            ...
                            type: this.noticeData.spe
                        }
                        this.$http.post3('/chem/disposal/process/executeProcess', data).then(res => {
                            if (res.data.code === 1) {
                                let data = {
                                        processInstanceId:this.processInstanceId
                                    }
                                ...
                                this.$router.push('/contingencyManage/event/chemical')
            ...
            saveData(){
                ...
                this.$http.post3('/chem/disposal/process/saveOrUpdate', data).then(res => {
                })
            },
            //回显测试
            viewData() {
                this.$http.get3('/chem/disposal/process/queryOne?processInstanceId=' + this.processInstanceId).then(res => {
                    ...
                    this.noticeData.spe= Number(tempData.type)
                    let data = {
                        processInstanceId:this.processInstanceId
                    }
                    this.$http.get3('/chem/disposal/process/config/taskKeyList', data).then(res => {
