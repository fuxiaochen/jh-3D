...
<script>
import Authorize from "./fighting/Authorize/Authorize";
import Security from "./fighting/security/security";
import Identify from "./fighting/identify/identify";
import Process from "./fighting/process/Process";
import Flowchart from "./fighting/flowchart/flowchart";
export default {
    components: {
        Authorize,
        Security,
