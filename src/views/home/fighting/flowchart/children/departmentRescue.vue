...
<script>
    ...
    export default {
        ...
        methods:{
            //回显测试
            viewData() {
                this.$http.get3('/fire/deptErt/rescue/queryOne?processInstanceId=' + this.processInstanceId).then(res => {
                    ...
                    this.rescueData = {
                        ...
                        removeDangerGoods:eval(tempData.removeDangerGoods),
                        ...
                        rescuePollutionTime:tempData.rescuePollutionTime,
                        rescuePollutionBar:tempData.rescuePollutionBar,

                        scenePollutionTime:tempData.scenePollutionTime,
                        scenePollutionBar:tempData.scenePollutionBar,

                        selfPollutionTime:tempData.selfPollutionTime,
                        selfPollutionBar:tempData.selfPollutionBar,
            ...
            submitForm(formName) {
                this.$refs[formName].validate(valid => {
                    if (valid) {
                        ...
                        this.$http.post3('/fire/deptErt/rescue/excuteProcess', data).then(res => {
                            this.isDisabled = true
                            if (res.data.code === 1) {
                                let data = {
                                    processInstanceId:this.processInstanceId
            ...
            saveData() {
                ...
                this.$http.post3('/fire/deptErt/rescue/saveOrUpdate', data).then(res => {
