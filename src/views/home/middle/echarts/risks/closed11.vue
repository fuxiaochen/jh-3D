<template>
  <div id="closed11" style="width:580px;height:185px"></div>
</template>
...
export default {
  ...
  methods: {
    initData2() {
      myChart2 = echarts.init(document.getElementById("closed11"));
      let option = {
        tooltip: {
          trigger: "axis",
          axisPointer: {
